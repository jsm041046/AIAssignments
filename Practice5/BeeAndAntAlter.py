...
if __name__ == '__main__':
    ...
    #use efficientnet
    model_conv = models.efficientnet_b0(weights='IMAGENET1K_V1')
    ...
    #optimize Intel GPU by ipex
    #previous hardware acceleration don't fit my environment
    model_conv, optimizer_conv = ipex.optimize(model_conv, optimizer=optimizer_conv)
